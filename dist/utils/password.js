...
const makeHashPassword = (password) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield bcrypt_1.default.hash(password, config_1.envConfig.salt_round);
    return result;
});
